...
Mathematical definitions of each model are in their own vignettes,
e.g. [`vignette("estimate_infections")`](https://epiforecasts.io/EpiNow2/dev/articles/estimate_infections.md).
