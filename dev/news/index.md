...
- Added
  [`estimate_dist()`](https://epiforecasts.io/EpiNow2/dev/reference/estimate_dist.md)
  function for estimating delay distributions with proper handling of
  interval censoring using Stan/MCMC inference, supporting both rstan
  and cmdstanr backends.
- Deprecated
  [`estimate_delay()`](https://epiforecasts.io/EpiNow2/dev/reference/estimate_delay.md)
  in favour of
  [`estimate_dist()`](https://epiforecasts.io/EpiNow2/dev/reference/estimate_dist.md),
  which correctly accounts for interval censoring and truncation.
